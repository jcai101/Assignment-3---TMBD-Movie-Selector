const movideIds = [857, 603692, 39514, 677179, 19995, 502356, 798286, 405775, 4247, 315162, 12162]
        ...
        for (let movie of moviesData.data.results) {   
            axios.get(`https://api.themoviedb.org/3/movie/${movie.id}`, {
                ...
                if (`${movie.id}` == movideIds[num]) {
                    ...
                    document.getElementById("tagline").innerHTML = `Tagline: ${extraData.data.tagline}`;  
                    ...
                    document.getElementById("revenue").innerHTML = `Budget: ${extraData.data.budget} | Revenue: ${extraData.data.revenue}`;
